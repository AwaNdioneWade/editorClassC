            ...
            <div className="container-fluid p-5 bg-dark" style={{height: '100%'}} >
              <div className='row'>
                <div className='col-12 col-md-8'>
                  <Textarea texte={this.state.texte} onChange={(e) => this.setState({texte: e.target.value})} style={{backgroundColor: '#95a3b3', color: '#fff', border: 'none', width: '100%', height: '500px' }}  />
                </div>
                <div className='col-12 col-md-3'>
                  <Texte texte={this.state.texte} style={{backgroundColor: '#fff', width: '100%', height: '250px' }} />
                </div>
              </div>
